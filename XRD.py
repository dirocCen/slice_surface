...
from pymatgen.analysis.diffraction.core import DiffractionPattern, AbstractDiffractionPatternCalculator, get_unique_families
...
a = XRDCalculator()
struct = Structure.from_file('POSCAR1.vasp')
XRD = a.get_pattern(struct, scaled=True, two_theta_range=(0, 90))

# print(XRD.y)
plt.stem(XRD.x, XRD.y, 'o')
plt.xlim(0, 90)       # x轴刻度范围
plt.ylim(0, 105)	    # y轴刻度范围
plt.xlabel('theta')   # x轴名称
